...
class Example_Client(jm.JobManager_Client):
    def __init__(self):
        ...
        super(Example_Client, self).__init__(
            server="localhost", authkey="simple example", verbose=0
        )
...
class Example_Server(jm.JobManager_Server):
    def __init__(self):
        ...
        super(Example_Server, self).__init__(authkey="simple example", verbose=1)
